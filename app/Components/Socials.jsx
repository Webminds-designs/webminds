  ...
  return (
    <main className={styles.main}>
      <div className={styles.container}>
        <MagneticIcons>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.5 58" aria-label="Social Icon 1">
        ...
        <MagneticIcons>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.13 46.08" aria-label="Social Icon 2">
        ...
        <MagneticIcons>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.1 36.69" aria-label="Social Icon 3">
        ...
        <MagneticIcons>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.26 53.87" aria-label="Social Icon 4">
            <path d="m34.27,18.6c0,4.82,0,9.64.03,14.47.01,2.53-.24,5.01-.67,7.5-.68,3.88-2.69,6.84-5.66,9.33-2.21,1.84-4.7,2.88-7.39,3.15-4.86.47-9.8.33-14.7-.55-1.59-.27-3.11-.76-4.62-1.39-2.55-1.03-5.14-2.43-7.09-4.45-1.99-1.78-3.67-3.88-4.78-6.2-1.71-3.14-2.65-6.47-3.27-9.83-.51-2.81-.72-5.67-.55-8.54,1.15-4.63,3.74-8.53,7.71-11.23,1.33-1.12,2.77-2.03,4.35-2.58,3.65-1.02,7.34-.44,10.72,1.47,1.98,1.04,3.79,2.48,5.46,4.16,2.15,2.05,4.06,4.37,5.44,6.88,1.32,2.36,2.46,4.79,2.83,7.49.17,1.2.3,2.44.28,3.68Z"/>
          </svg>
        </MagneticIcons>
      </div>
    </main>
