...
const BigFotterText = () => {
        ...
        { opacity: 0, y: 50 }, // Initial state
        {
          ...
          onComplete: () => {
            ...
            gsap.to(textElement, {
              ...
              duration: 180, // Duration for one loop
  ...
  return (
    <>
      <div className="w-screen overflow-hidden  pb-8">
        <div
          ref={textRef}
          className="text-[280px] opacity-65 text-text font-semibold whitespace-nowrap"
        ...
        >
          ...
          {"Get In Touch - Contact Us - Get In Touch - Contact Us - Get In Touch - Contact Us -"
            .split("")
            .map((char, index) => (
              <span
                key={index}
