      ...
      >
        ...
        >
          ...
          >
            ...
            . In our team of eighteen, creativity meets purpose, and modern
            ideas blend seamlessly with timeless vision. We’re not just a team;
            we’re a platform for bold thinkers and innovative doers. Living at
            the pulse of the digital world, we thrive on redefining what’s
            possible. That’s why our partners trust us to elevate their brands,
            build stunning websites, and craft campaigns that leave an
            impression. We don’t just follow trends—we create them.
          </div>
        </motion.div>
        <div
          className="relative bg-black md:w-screen h-screen md:h-fit"
